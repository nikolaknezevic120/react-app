...
export default function WebShopMain() {
  ...
  const itemOrder = ' kom. domaći dres\nveličina: ';
  const item1order = ' kom. gostujući dres\nveličina: ';
  const item2order = ' kom. treći dres\nveličina: ';
  const item3order = ' kom. jastuk\n';
  const item4order = ' kom. šalica\n';
  const item5order = ' kom. upaljač\n';
      ...
      <Container fluid>
        <Row>
          ...
          <Col xs={12} md={3}>
            ...
            {showContinueOrder ? <Button id='finishOrder' onClick={finishOrderFunc}>Završi narudžbu</Button> : null}
      ...
      <Container fluid>
        <Row>
          ...
          <Col xs={12} md={3}>
            ...
            {showContinueOrder ? <UserInput /> : null}
            {showContinueOrder ? <Button id='finishOrder' onClick={finishOrderFunc}>Continue</Button> : null}
            {finishOrder ? <PayMethod /> : null}
          </Col>
        </Row>
